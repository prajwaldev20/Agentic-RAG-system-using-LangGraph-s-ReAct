...
class VectorRerankerSearchTool(BaseTool):
    ...
    def _run(self, query: str) -> str:
        ...
        raise NotImplementedError("Build VectorRerankerSearchTool._run — see Milestone 5")
...
class WebSearchTool(BaseTool):
    ...
    def _run(self, query: str) -> str:
        ...
        raise NotImplementedError("Build WebSearchTool._run — see Milestone 5")
...
class CompanyDirectorsTool(BaseTool):
    ...
    def _run(self, query: str) -> str:
        ...
        try:
            ...
            if section is None:
                return f"No director section found for '{company}'. Available: {list(self.director_sections.keys())}"
            ...
            if include_linkedin:
                ...
                for name in names:
                    ...
                    entries.append(f"{name} (LinkedIn: {handle})")
                return "; ".join(entries)
            else:
                return ", ".join(names)
        except Exception as e:
        ...
        raise NotImplementedError("Build CompanyDirectorsTool._run — see Milestone 5")
    ...
    def _extract_director_names(self, text: str) -> List[str]:
        ...
        raise NotImplementedError("Build CompanyDirectorsTool._extract_director_names — see Milestone 5")
    ...
    def _get_linkedin_handle(self, name: str, company: str) -> str:
        ...
        try:
            ...
            return f"Error looking up LinkedIn: {str(e)}"



        raise NotImplementedError("Build CompanyDirectorsTool._get_linkedin_handle — see Milestone 5")
